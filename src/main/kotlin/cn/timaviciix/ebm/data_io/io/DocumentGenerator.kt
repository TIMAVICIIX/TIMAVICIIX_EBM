...
import cn.timaviciix.ebm.data_io.DataTemplate
import cn.timaviciix.ebm.data_io.ElementTemplate
import cn.timaviciix.ebm.data_io.TransType
...
object DocumentGenerator {
    ...
    fun Document.deployAllElement(dataElement: DataTemplate) {
        dataElement.elementList.forEach {
            if (it.storageType != TransType.NBT) {
