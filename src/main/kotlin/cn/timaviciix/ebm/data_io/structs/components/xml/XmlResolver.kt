...
class XmlResolver(private val xpath: MutableList<String>) {
    constructor(signalXpath: String) : this(xpath = mutableListOf<String>().also { it.add(signalXpath) })

    companion object {
        val EMPTY = XmlResolver(mutableListOf())
         val DEFAULT_ROOT by XmlResolverDelegate()
    }
