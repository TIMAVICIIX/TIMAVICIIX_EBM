...
class QuartzGildedBookBlock : BaseBookBlock(BookType.GeneralBook),
    BlockEntityProvider, BookBlockInterface {

    override fun createBlockEntity(pos: BlockPos?, state: BlockState?): BlockEntity? {
        return if (pos != null && state != null) {
            GeneralBookBlockEntity(GeneralBookRegister.EntityTypes.GENERAL_QUARTZ_GILDED_BOOK_TYPE, pos, state)
        } else {
            null
        }
    }
