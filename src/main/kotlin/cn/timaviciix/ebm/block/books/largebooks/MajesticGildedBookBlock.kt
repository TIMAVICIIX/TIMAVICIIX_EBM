...
class MajesticGildedBookBlock : BaseBookBlock(BookType.LargeBook),
    BlockEntityProvider, BookBlockInterface {

    override fun createBlockEntity(pos: BlockPos?, state: BlockState?): BlockEntity? {
        return if (pos != null && state != null) {
            LargeBookBlockEntity(LargeBookRegister.EntityTypes.LARGE_MAJESTIC_GILDED_BOOK_TYPE, pos, state)
        } else {
            null
        }
    }
